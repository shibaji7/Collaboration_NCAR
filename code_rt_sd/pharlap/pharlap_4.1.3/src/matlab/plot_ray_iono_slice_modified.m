...
function [axis_handle, ray_handle] = plot_ray_iono_slice_modified(iono_grid, ...
      start_range, end_range, range_inc, start_height, end_height, ...
      height_inc, ray, varargin, ray_bear, origin_lat, origin_long)
...
[geo_lat, geo_long] = raz2latlon(range, ray_bear, origin_lat, origin_long);
