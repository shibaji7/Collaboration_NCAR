...
function [iono_pf_grid, iono_pf_grid_5, collision_freq, irreg, ...
	 iono_te_grid] = ...
            gen_iono_grid_2d_sneh(origin_lat, origin_lon, R12, UT, azim, ...
    ...
    if (~strcmpi(profile_type, 'chapman_fllhc') & ...
            ~strcmpi(profile_type, 'chapman') & ...
            ~strcmpi(profile_type, 'iri') & ...
            ~strcmpi(profile_type, 'iri2007') & ...
            ~strcmpi(profile_type, 'iri2012') & ...
            ~strcmpi(profile_type, 'iri2016') & ...
            ~strcmpi(profile_type, 'firi') )
...
function [iono_pf_prof, iono_pf_prof5, iono_extra, iono_te_prof] = ...
    ...
    if strcmpi(profile_type, 'chapman')
    ...
    elseif (strcmpi(profile_type, 'iri') | ...
            strcmpi(profile_type, 'iri2016') | ...
            strcmpi(profile_type, 'firi') )
        
        firi_flag = strcmpi(profile_type, 'firi');
    ...
    elseif (strcmpi(profile_type, 'iri2012') )
    ...
    elseif strcmpi(profile_type, 'iri2007')
