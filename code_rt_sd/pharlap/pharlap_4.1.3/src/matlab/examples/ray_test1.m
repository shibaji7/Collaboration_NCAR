...
% setup general stuff
%
UT = [2015 3 11 16 20];        % UT - year, month, day, hour, minute
R12 = 100;                   % R12 index
...
load('/home/shibaji7/pharlap_4.1.3/sami_parsed.mat')
%iono_en_grid = dene(:,:,1);
%iono_en_grid = reshape(iono_en_grid,[200,201]);
%iono_en_grid_5 = iono_en_grid;
%collision_freq = reshape(collision_freq,[201,200]);
