...
if __name__ == "__main__":
        ...
        parser.add_argument("-mr", "--mrange", type=float, default=1000., help="Max ground range in km (default 1000 km)")
        parser.add_argument("-nmr", "--nmrange", type=int, default=101, help="Number of steps in ground range (default 101)")
