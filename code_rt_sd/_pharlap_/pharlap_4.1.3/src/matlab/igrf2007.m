...
%   distributed with the IRI-2007 fortan based empirical model ionosphere. 
%   Returns modeled geomagnetic field.
%
% Calling sequence :
%    mag_field = igrf2007(lat, lon, UT, height)
%
% Inputs :
...
% (igrf2007_matlab_wrapper.for) to the Fortran code (igrf.for).
