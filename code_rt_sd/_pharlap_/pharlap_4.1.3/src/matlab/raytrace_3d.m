...
%           raytrace_3d(origin_lat, origin_long, origin_ht, elev, ray_bearing,
%                       freq, OX_mode, nhops, tol, iono_en_grid, ...
...
%           raytrace_3d(origin_lat, origin_long, origin_ht, elev, ray_bearing,
%                       freq, OX_mode, nhops, tol)
%
%   4.  [ray_data, ray_path_data, ray_state_vec] = ...
%           raytrace_3d(origin_lat, origin_long, origin_ht, elev, ray_bearing,
%                       freq, OX_mode, nhops, tol, ray_state_vec_in)
%
...
%   collision_freq    function of WGS84 latitude, longitude and height. The 
%                     maximum grid sizes are 701 X 701 X 401 (lat, lon, height).
%                     (501 x 501 x 301 on 32-bit Windows platforms). The 
%                     ionospheric data and their gradients must be smooth and 
%                     continuous. See also note 2 below on memory. 
%
...
%     ray_data(1, :)  = geodetic (WGS84) latitude of end point of ray (degrees)
%     ray_data(2, :)  = geodetic (WGS84) longitude of end point of ray (degrees)
...
%                   along it's path
%      ray_path_data(1, :) = geodetic (WGS84) latitude (degrees)
%      ray_path_data(2, :) = geodetic (WGS84) longitude (degrees)
%      ray_path_data(3, :) = height of ray above WGS84 ellipsoid, km
...
%      ray_path_data(14-16, :) = WGS84 x,y,z components of geomagnetic field
%      ray_path_data(17, :)    = geometrical distance travelled by ray (km)
%                                                                           
%   nhops_attempted - number of hops attempted                            
%
%   ray_label  - array (of size nhops_attempted X 1) containing a label for 
%                each hop which indicates what the ray has done.
%                = 1  for ray reaching ground                           
...
%      ray_state_vec(1 - 3, :)  = WGS84 x, y and z position of ray (m)
%      ray_state_vec(4 - 6, :)  = WGS84 x, y, and z components of vector with a 
