...
mcsat%%.dat     Monthly coefficient files for the Shubin(2015) hmF2 model based on
                COSMIC data; %% = month+10
...
CCIR%%.ASC,     Coefficient files for the global representation of the F2 peak
   URSI%%.ASC	peak parameters (foF2, M3000) where %% = Month+10 (ASCII). CCIR is
                ...
                [These files are the same for all versions of IRI and are available
                from a separate download link on the IRI homepage].
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
